...
try {
  ...
  (function UseRestParameter() {
    ...
    function foo(a, b, ...yeet) {
      return a + b + yeet.length;
    }
  ...
  (function UseArrow1() {
    ...
    // Får ikke denne testen til å kjøre. Tror det er en bug i CodeSandbox.
  ...
  (function UsePropertyShorthand() {
    ...
    // KOMMENTAR
    // Skal det være dutch overalt, eller er det meningen at det skal være dutch i toEqual funksjonen?
